        ...
        <div class="card-body">
          <form @submit.prevent="registerUser">
            <div class="form-group">
              ...
              <input id="forename" type="text" placeholder="Forename" name="forename" v-model="givenName"
                class="form-control" />
            </div>
            <div class="form-group">
              <label for="Surname">Surname</label>
              <input id="surname" type="text" placeholder="Surname" name="surname" v-model="familyName"
                class="form-control" />
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <vue-tel-input id="telephone_number" type="numbers" placeholder="Telephone number" name="telephone_number"
                v-model="number" class="form-control" />
            </div>
            <div class="form-group">
  ...
  export default {
    ...
    methods: {
      ...
      async registerUser() {
        ...
        api.registerUserWithPatch(user, this.idFromParams).then((createResult) => {
          console.log(createResult, "create user");
          createResult.isActive = true;
          api.updateUser(createResult, createResult._id).then((patchResult) => {
            console.log(patchResult, "patch user")
            this.$router.push("/home")
            this.$store.dispatch("setUser", createResult);
