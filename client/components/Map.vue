<template>
  <div>
    ...
    <GmapMap ref="map" :center="this.center" :zoom="13" map-type-id="terrain" style="width: 500px; height: 300px"
      @click="getClickinfo">
  ...
  export default {
    ...
    methods: {
      ...
      goToSearchResult: function (searchResult) {
        ...
        console.log(this.currentLocation.geometry.location.lat(), this.currentLocation.geometry.location.lng())
